...
def get_args():
    ...
    update_delay         |   update delaying for actor network
    ...
    target_noise_scale   |   the scale of the truncated Gaussian noise on the target action for a smoother target Q value
    target_noise_clip    |   the clipping threshold of the truncated Gaussian noise on the target action
    ...
    """
    parser = argparse.ArgumentParser(description="td3 parser")
    ...
    parser.add_argument("--update_delay", default=2, type=int, \
        help="update delaying for actor network")
    ...
    parser.add_argument("--target_noise_scale", default=0.2, type=float, \
        help="the scale of the truncated Gaussian noise on the target action for a smoother target Q value")
    parser.add_argument("--target_noise_clip", default=0.5, type=float, \
        help="the clipping threshold of the truncated Gaussian noise on the target action")
