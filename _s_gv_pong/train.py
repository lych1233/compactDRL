    ...
    for ep in range(10):
        ...
        for t in range(190000):
            ...
            if done:
                ...
                print('Iteration %d, Episode %d (%d timesteps) - last_action: %d, last_action_prob: %.2f, reward_sum: %.2f, running_avg: %.2f, t: %d' % (it, ep, t, action, action_prob, reward_sum, reward_sum_running_avg, t))
