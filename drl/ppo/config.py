...
def get_args():
    ...
    ---------------------------------------------------------------------------
    policy_lr       |   the learning rate of the policy network
    critic_lr       |   the learning rate of the critic network
    ...
    parser.add_argument("--sample_steps", default=4096, type=int, \
...
def argument_complement(parser):
    ...
    parser.add_argument("--wandb_job_type", default="ppo training", type=str, \
