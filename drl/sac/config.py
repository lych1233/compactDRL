...
def get_args():
    ...
    """
    parser = argparse.ArgumentParser(description="sac parser")

    parser.add_argument("--lr", default=1e-3, type=float, \
        help="the learning rate of the actor/critc network")
    ...
    parser.add_argument("--alpha", default=0.2, type=float, \
        help="temprature for the maximum entropy objective function")
    parser.add_argument("--tau", default=0.005, type=float, \
        help="update coefficient τ for soft target network update")
    parser.add_argument("--additional_OU_noise", default=-1, type=float, \
        help="(if > -1) add addintional Ornstein Uhlenbeck noise for better exploration")
    parser.add_argument("--log_std_min", default=-20, type=float, \
        help="log_std lowerbound of the Gaussian policy")
    parser.add_argument("--log_std_max", default=2, type=float, \
        help="log_std upperbound of the Gaussian policy")
